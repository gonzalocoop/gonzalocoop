...
<br>
 ...
 [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Architects+Daughter&color=149414&size=30&lines=+Views!)](https://git.io/typing-svg)
<br><br>
...
## My University Projects (All Period)

<br><br>

- :school: Mill Game `First Period` (https://github.com/gonzalocoop/MillGame).
- :school: Classification of Relations `Third Period` (https://github.com/gonzalocoop/ClassificationRelations).
- :school: Graphical Representation of Connected Components Of a Graph `Fourth Period` (https://github.com/gonzalocoop/ComponentsOfGraph).
- :school: MedicVerse Web Page (Only HTML, CSS y JS) `Fourth Period` (https://github.com/gonzalocoop/MedicVerse).
- :school: Page for The Barber Company (Using Windows Forms and SQL) `Fifth Period` (https://github.com/gonzalocoop/TheBarberCompanySystemAndDataBase).
- :school: MindFulLife Website (Backend and Frontend) `Sixth Period` (https://github.com/gonzalocoop/SI62_Grupo5_MindFulLife).
